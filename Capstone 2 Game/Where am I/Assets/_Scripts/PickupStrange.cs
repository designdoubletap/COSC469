...
public class PickupStrange : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (pickedUp == true)
        {
            ...
            else if (Input.GetKeyDown(KeyCode.F))
            {
                ...
                for (int i = 0; i < 60; i++)
                {
                    Camera.main.GetComponent<UnityStandardAssets.ImageEffects.Fisheye>().strengthX = Random.Range(0f, 1.5f);
                    Camera.main.GetComponent<UnityStandardAssets.ImageEffects.Fisheye>().strengthY = Random.Range(0f, 1.5f);
                }
