...
public class PickupClear : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (pickedUp == true)
        {
            ...
            else if (Input.GetKeyDown(KeyCode.F))
            {
                ...
                Camera.main.GetComponent<UnityStandardAssets.ImageEffects.BlurOptimized>().downsample = 0;
                Camera.main.GetComponent<UnityStandardAssets.ImageEffects.BlurOptimized>().blurSize = 0;
